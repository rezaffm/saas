...
Route::group(['middleware' => ['verified', 'subscription.active']], function() {
...
Route::group(['prefix' => 'account', 'middleware' => ['auth'], 'as' => 'account.', 'namespace' => 'Account'], function() {
    ...
    Route::group(['prefix' => 'subscription', 'namespace' => 'Subscription', 'middleware' => ['subscription.owner']], function () {
        ...
        Route::group(['middleware' => 'subscription.team'], function () {
            ...
            Route::post('/team/member', 'SubscriptionTeamMemberController@store')->name(
                'subscription.team.member.store'
            );
            Route::delete('/team/member/{user}', 'SubscriptionTeamMemberController@destroy')->name(
                'subscription.team.member.destroy'
            );
        });
    });
});
...
Route::group(['prefix' => 'subscription', 'middleware' => ['auth.register', 'subscription.inactive'], 'as' => 'subscription.'], function() {
